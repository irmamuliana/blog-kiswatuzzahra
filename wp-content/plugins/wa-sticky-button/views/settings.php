        ...
        <div class="wrap" style="padding-bottom: 300px;">
            <table class="widefat">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="okapi-wasb-td-1">
                            <?php _e('WhatsApp Default Message', 'wa-sticky-button'); ?> <span class="required">*</span> 
                        </td>
                        <td class="okapi-wasb-td-2">
...
jQuery(document).on("click", "#okapi-wasb-save-settings", function(){
    ...
    if(msg == ""){
        jQuery("#okapi-wasb-msg").next(".okapi-wasb-error").html("Please enter WhatsApp default message.");
        status = false;
    }
    if(width == ""){
