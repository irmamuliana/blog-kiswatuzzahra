...
if ( ! class_exists( 'Feminine_Pink_Slider_Control' ) ) {

	/**
	 * Slider control (range).
	 */
	class Feminine_Pink_Slider_Control extends Wp_Customize_Control {
        ...
        public function enqueue() {            
            wp_enqueue_style( 'feminine-pink-slider', get_stylesheet_directory_uri() . '/inc/custom-controls/slider/slider.css', null );
            wp_enqueue_script( 'feminine-pink-slider', get_stylesheet_directory_uri() . '/inc/custom-controls/slider/slider.js', array( 'jquery' ), false, true ); //for slider                
        }
